...
// scanf("%d",&b2);
 ...
 printf("\n");
 printf("#####################################################################################################\n");
 printf("#	This file made by J.Chae 23-01-06 version							#\n");
 printf("#	You need to EIGENVAL, DOSCAR, PROCAR in this directory.						#\n");
 printf("#	I recommend the DOSCAR was calculated in gamma-centered k-mesh, even when not line-mode in KPOINTS.	#\n");
 printf("#	You should set the same number of ions in DOSCAR and PROCAR.					#\n");
 printf("#####################################################################################################\n");
 printf("\n");
